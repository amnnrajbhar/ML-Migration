...
@Component({
  selector: 'app-assessmentmasterreport',
  templateUrl: './assessmentmasterreport.component.html',
  styleUrls: ['./assessmentmasterreport.component.css']
})
export class AssessmentmasterreportComponent implements OnInit {
...
private initDatatable(): void {
  ...
  $('#assessment tfoot th').each( function () {
    var title = $('#assessment thead th').eq( $(this).index() ).text();
...
this.tableWidget = table;
  $("#assessment tfoot input").on( 'keyup change', function () {
    table

...
@Component({
    selector: 'app-LeaveandODintimation',
    templateUrl: './LeaveandODintimation.component.html',
    styleUrls: ['./LeaveandODintimation.component.css']
})
export class LeaveandODintimationComponent implements OnInit {

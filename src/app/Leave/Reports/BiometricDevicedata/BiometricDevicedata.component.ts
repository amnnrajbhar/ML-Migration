...
@Component({
    selector: 'app-BiometricDevicedata',
    templateUrl: './BiometricDevicedata.component.html',
    styleUrls: ['./BiometricDevicedata.component.css']
})
export class BiometricDevicedataComponent implements OnInit {

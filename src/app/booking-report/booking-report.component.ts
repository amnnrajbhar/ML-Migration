...
import { BookMeeting } from '../bookmeetingroom/room-booking/bookmeeting.model';
import { GenericBookingFilters } from '../bookmeetingroom/genericbookingfilters.model';
...
export class BookingReportComponent implements OnInit {
  ...
  getMyMeetings() {
    ...
    if (this.selectedRoomType != null) {
      let types = null;
      this.selectedRoomType.forEach(loc => {
        types = loc.type + ',' + types;
      });
      genericBookingFilters.roomType = types;
    }
  ...
  exportAsXLSX(): void {
    ...
    this.myMeetings.forEach(item => {
      ...
      let exportItem={
        ...
        "Room Location":item.roomLocationCode+'-'+item.roomLocationName,
    ...
    this.excelService.exportAsExcelFile(this.exportList, 'Room Booking Report');
  }

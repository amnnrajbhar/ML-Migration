...
@Component({
  ...
  templateUrl: './guesthouse-facilities.component.html',
  styleUrls: ['./guesthouse-facilities.component.css']
})
export class GuesthouseFacilitiesComponent implements OnInit {
  ...
  //AuditLogging
  masterName: string = 'Guest House Facility master'; // Change MasterName

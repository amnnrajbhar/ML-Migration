...
@Component({
    ...
    templateUrl: './DLSTransReports.component.html',
...
// pdfMake.vfs = pdfFonts.pdfMake.vfs;
    ...
    private initDatatable1(): void {
        let exampleId: any = jQuery('#docTable');
...
this.filterType = '';
 ...
 this.filterlocation = '';
    ...
    getAllEntries() {
        ...
        this.httpService.DLSpost(APIURLS.BR_GET_DLS_TRANS_REPORT_DATA,filterModel).then((data: any) => {
            if (data) {

...
@Component({
  selector: 'app-readonlyemployee-salary',
  templateUrl: './readonlyemployee-salary.component.html',
  styleUrls: ['./readonlyemployee-salary.component.css']
})

export class ReadonlyemployeeSalaryComponent implements OnInit {

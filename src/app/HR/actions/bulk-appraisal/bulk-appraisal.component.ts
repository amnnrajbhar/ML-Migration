...
@Component({
  selector: 'app-bulk-appraisal',
  templateUrl: './bulk-appraisal.component.html',
  styleUrls: ['./bulk-appraisal.component.css']
})
export class BulkAppraisalComponent implements OnInit {
...
this.currentUser = storedUser ? JSON.parse(storedUser) : null;
  ...
  bulkUpload(): void {
    ...
    //this.isLoading = true;
    this.httpService.HRpostAttachmentFileWithReturn(APIURLS.HR_EMPLOYEE_BULK_UPLOAD_APPRAISAL, this.data).then((data: any) => {
  ...
  public uploadFile(): void {
    ...
    this.httpService.HRpostAttachmentFileWithReturn(APIURLS.HR_EMPLOYEE_BULK_UPLOAD_APPRAISAL + "?userId=" + userId, formData).then((data: any) => {
      this.isLoading = false;

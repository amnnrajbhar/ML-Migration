...
@Component({
  ...
  templateUrl: './appraisal-view.component.html',
  styleUrls: ['./appraisal-view.component.css'],
  providers: [Util]
})
...
@ViewChild(ReadonlyemployeeSalaryComponent, { static: false }) employeeSalaryComponent: ReadonlyemployeeSalaryComponent;
  ...
  comments:string;
  employeeDetail: any = {};
  IsDesignationChange: any = "No";
  IsRoleChange: any = "No";
  IsTransfer: any =  "No";
  IsSalaryChange: any = "No";
  IsStaffCategoryChange: any =  "No";

...
statusList = [
  ...
  ngOnInit() {
    ...
    this.filterModel.selectedFromdate = null;
    this.filterModel.selectedTodate = null;
    this.getPlantList();
  ...
  getData(){
    this.isLoading = true;    
    this.httpService.HRpost(APIURLS.RESIGNATION_GET_CHECKLIST_BY_FILTER, this.filterModel).then((data: any) => {

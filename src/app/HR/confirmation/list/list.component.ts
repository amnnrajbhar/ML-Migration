...
export class ListComponent implements OnInit {
  constructor(private appService: AppComponent, private httpService: HttpService,
    ...
    private dataStore: DataStorageService, private excelService: ExcelService, private http: HttpClient, private util: Util) {
...
this.currentUser = storedUser ? JSON.parse(storedUser) : null;
  ...
  errorCount = 0;
  approvalSubmitBulk() {
    var selectedList = this.filterData.list.filter((x:any)  => x.selected && x.isBulkUpload == "Yes" && x.status == "Initiated");

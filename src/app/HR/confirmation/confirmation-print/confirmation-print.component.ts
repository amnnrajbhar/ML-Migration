...
@Component({
  ...
  styleUrls: ['./confirmation-print.component.css'],
  providers: [Util]
})
...
this.currentUser = storedUser ? JSON.parse(storedUser) : null;
      ...
      this.LoadDetails(this.employeeConfirmationId);
      this.getbase64image();
    }
  }
  ...
  createPDF(forPrinting: boolean) {
    ...
    var logo = this.image;
    var footNote = this.details.salaryChanged == false ? "" : "Please note that your remuneration package is strictly Confidential between you and the Organization and any breach of this confidentiality on your part would be viewed seriously.";
    var pageMarginsConfig =  [40, 50, 40, 40];
    // pdfMake.fonts = {     
    //   Times: {
    //     normal: 'Times-Roman',
    //     bold: 'Times-Bold',
...
//    return pdfMake.createPdf(docDefinition);
  ...
  sendEmail() {
    ...
    if (confirm("Are you sure you want to send email?")) {
      //var request: any = {};
      this.request.employeeConfirmationId = this.employeeConfirmationId;

...
@Component({
    ...
    templateUrl: './FinanceApproval.component.html',
    styleUrls: ['./FinanceApproval.component.css']
})
...
export class FinanceApprovalComponent implements OnInit {
    ...
    getAllEntries() {
        ...
        filterModel.type = "Finance Approval Request";
    ...
    changesremainingfieldvalue(event) {
        if (event.value == 'N') {
            ...
            this.ItemCodeRequestModel.itemFromMultipleVendors = '2';
  ...
  <div>     
    ...
    showCheckbox(request: ItemCodeRequest): boolean {
        if (request.approver1 == this.currentUser.employeeId || request.approver2 == this.currentUser.employeeId || request.approver3 == this.currentUser.employeeId || request.approver4 == this.currentUser.employeeId 
            || request.approver5 == this.currentUser.employeeId || request.pendingApprover == this.currentUser.fullName) {
            return true;
        }
    ...
    isBulkApproveLoading: boolean = false;
    bulkApprove() {
        this.errMsg = "";
